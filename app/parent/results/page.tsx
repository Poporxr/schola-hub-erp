...
import { Calendar, Download, Hash, Printer, School, Search, Sliders, Subscript } from "lucide-react";
...
const ward = [
    { id: '1', name: 'Benita Emmanuel' },
    { id: '2', name: 'David Emmanuel' }
]
const Page = () => {
    return (
        <div>
                ...
                <form className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <Select >
                            ...
                            <SelectContent className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700">
                                <SelectGroup >
                                    {terms.map((term) => {
                                        return (
                                            <SelectItem key={term.id} className="cursor-pointer bg-gray-100 hover:bg-gray-200 text-black" value={term.id}>{term.name}</SelectItem>
                                        )
                                    })}
                                </SelectGroup>
                            </SelectContent>
                    ...
                    <div>
                        ...
                        <Select>
                            ...
                            <SelectContent className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700">
                                <SelectGroup>
                                    <SelectItem className="cursor-pointer bg-gray-100 hover:bg-gray-200 text-black" value="First Term">2023/2024</SelectItem>
                                    <SelectItem className="cursor-pointer bg-gray-100 hover:bg-gray-200 text-black" value="Second Term">2024/2025</SelectItem>
                                    <SelectItem className="cursor-pointer bg-gray-100 hover:bg-gray-200 text-black" value="Third Term">2025/2026</SelectItem>
                                </SelectGroup>
                            </SelectContent>
                        </Select>
                    </div>
                        ...
                        <Select >
                            ...
                            <SelectContent className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700">
                                <SelectGroup >
                                    {ward.map((wd) => {
                                        return (
                                            <SelectItem key={wd.id} className="cursor-pointer bg-gray-100 hover:bg-gray-200 text-black" value={wd.id}>{wd.name}</SelectItem>
                                        )
                                    })}
                                </SelectGroup>
                            </SelectContent>
