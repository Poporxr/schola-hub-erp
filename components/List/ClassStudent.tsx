                ...
                {filteredStudents.map((student) => (
                    <div className="p-4 hover:bg-gray-50" key={student.id}>
                        <div className="flex items-start gap-3 mb-3">
                            <Image src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop" alt="Student" className="w-12 h-12 rounded-full object-cover shrink-0" width={10} height={10} />
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex gap-2">
                                <Link href={`/admin/students/${student.id}`} className="text-indigo-600 hover:text-indigo-900 text-xs font-medium">View</Link>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        ...
                        <tr className="hover:bg-gray-50" key={student.id}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <Link href={`/teacher/students/${student.id}`} className="text-indigo-600 hover:text-indigo-900 mr-3">View</Link>
                                {role === 'admin' && <DeleteButton teacher={student} type="student"/>}
                            </td>
                        </tr>
                        ))}
